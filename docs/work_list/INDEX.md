...
| 2026-04-29 | [2026-04-29_탭화이트리스트및icon.sh개선.md](2026-04-29_탭화이트리스트및icon.sh개선.md) | 탭 화이트리스트 적용 (탐지 분석 4개 메뉴만 탭), icon.sh Java17 감지·PG 패스워드·포트 감지 개선, agent_id 마이그레이션 추가 |
